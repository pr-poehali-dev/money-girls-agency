...
const Index = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Выплаты производятся еженедельно на электронный кошелёк AdvCash. Минимальная сумма для вывода — 30$.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Нет, опыт не требуется. Мы предоставляем бесплатное обучение от нашего агентства',
    },
    {
